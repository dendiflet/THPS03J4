...
class View
  ...
  def turn_ask(case_deja_jouee, actual_player)
    ...
    print "\nces cases on déja été jouée :  #{case_deja_jouee} \n"
...
if all_cases.uniq! == nil
  puts "#{" "*30}cette case n'existe pas connard\n"
...
puts "tu as bien rentrer une case du jeu"
 ...
 if ("1".."3").cover? ("#{case_just_proposed[0].chr}")
  ...
  case_just_proposed_ok << case_just_proposed[0]
end
    ...
    case_allready_played = case_deja_jouee.uniq!

binding.pry


 	  if case_allready_played == nil   #si pas en double uniq! renvoye nil
